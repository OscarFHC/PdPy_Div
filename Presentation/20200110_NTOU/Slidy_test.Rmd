...
```{r positiveBEF, fig.cap = "Cardinale et al. 2012 @ Nature", fig.align = 'center', fig.width = 36}
include_graphics("positiveBEF.png")
``` 

#

```{r consumerBEF, fig.cap = "Griffin et al. 2013 @ Ecology", fig.align = 'center', fig.width = 36}
...
```{r PdPyDiv_EF, fig.align = 'center', fig.width = 36}
...
```{r Hypo, fig.align = 'center', fig.width = 36}
...
```{r bNTI, fig.cap = "Stegen et al. 2012 @ ISME", fig.align = 'center', fig.width = 36}

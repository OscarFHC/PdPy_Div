...
Bacq0_HNFq1_mod1.0 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + Bac_select
    ln.HNF_q1 ~ HNF_select
    ln.Bac_Biom ~ ln.Bac_q0 + ln.HNF_q1
    ln.HNF_Biom ~ ln.Bac_Biom + ln.Bac_q0 + ln.HNF_q1
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
'
Bacq0_HNFq1_mod1.1 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + ln.HNF_Biom + Bac_select
    ln.HNF_q1 ~ HNF_select
    ln.Bac_Biom ~ ln.Bac_q0 + ln.HNF_q1
    ln.HNF_Biom ~ ln.Bac_Biom + ln.HNF_q1
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
'
Bacq0_HNFq1_mod1.2 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + Bac_select
    ln.HNF_q1 ~ ln.Bac_Biom + HNF_select
...
Bacq0_HNFq1_mod1.4 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + Bac_select
    ln.HNF_q1 ~ ln.Bac_Biom + HNF_select
    ln.Bac_Biom ~ ln.HNF_Biom + ln.Bac_q0 + ln.HNF_q1
    ln.HNF_Biom ~ ln.Bac_q0 + ln.HNF_q1
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
'
Bacq0_HNFq1_mod1.5 <- '
...
Bacq0_HNFq1_mod1.8 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + ln.Bac_Biom + Bac_select
    ln.HNF_q1 ~ HNF_select
    ln.Bac_Biom ~ ln.HNF_q1
    ln.HNF_Biom ~ ln.Bac_Biom + ln.Bac_q0 + ln.HNF_q1
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
'
Bacq0_HNFq1_mod1.9 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + ln.Bac_Biom + ln.HNF_Biom + Bac_select
    ln.HNF_q1 ~ HNF_select
    ln.Bac_Biom ~ ln.HNF_q1
    ln.HNF_Biom ~ ln.Bac_Biom + ln.HNF_q1
    Bac_select ~ ln.HNF_q1
...
Bacq0_HNFq1_mod1.12 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + ln.Bac_Biom + Bac_select
    ln.HNF_q1 ~ HNF_select
    ln.Bac_Biom ~ ln.HNF_Biom + ln.HNF_q1
    ln.HNF_Biom ~ ln.Bac_q0 + ln.HNF_q1
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
'
...
Bacq0_HNFq1_mod1.16 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + Bac_select
    ln.HNF_q1 ~ ln.HNF_Biom + HNF_select
    ln.Bac_Biom ~ ln.Bac_q0 + ln.HNF_q1
...
Bacq0_HNFq1_mod1.18 <- '
  # regressions
    ln.Bac_q0 ~ ln.HNF_q1 + Bac_select
    ln.HNF_q1 ~ ln.Bac_Biom + ln.HNF_Biom + HNF_select
    ln.Bac_Biom ~ ln.Bac_q0
    ln.HNF_Biom ~ ln.Bac_Biom + ln.Bac_q0
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
...
Bacq0_HNFq1_mod1.32 <- '
  # regressions
    ...
    ln.HNF_q1 ~ ln.Bac_q0 + HNF_select
    ln.Bac_Biom ~ ln.Bac_q0 + ln.HNF_q1
    ln.HNF_Biom ~ ln.Bac_Biom + ln.Bac_q0 + ln.HNF_q1
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
...
Bacq0_HNFq1_mod1.34 <- '
  # regressions
    ln.Bac_q0 ~ Bac_select
    ln.HNF_q1 ~ ln.Bac_q0 + ln.Bac_Biom + HNF_select
    ln.Bac_Biom ~ ln.Bac_q0
    ln.HNF_Biom ~ ln.Bac_Biom + ln.Bac_q0 + ln.HNF_q1
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
...
Bacq0_HNFq1_mod1.48 <- '
  # regressions
    ln.Bac_q0 ~ Bac_select
    ln.HNF_q1 ~ ln.Bac_q0 + ln.HNF_Biom + HNF_select
    ln.Bac_Biom ~ ln.Bac_q0 + ln.HNF_q1
    ln.HNF_Biom ~ ln.Bac_Biom + ln.Bac_q0
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
...
Bacq0_HNFq1_mod1.50 <- '
  # regressions
    ln.Bac_q0 ~ Bac_select
    ln.HNF_q1 ~ ln.Bac_q0 + ln.Bac_Biom + ln.HNF_Biom + HNF_select
    ln.Bac_Biom ~ ln.Bac_q0
    ln.HNF_Biom ~ ln.Bac_Biom + ln.Bac_q0
    Bac_select ~ ln.HNF_q1
    HNF_select ~ ln.Bac_q0
...
'
Bacq0_HNFq1_lavaan1.61 <- sem(Bacq0_HNFq1_mod1.61, data = HNF_Bac_A)
summary(Bacq0_HNFq1_lavaan1.61)
...
Bacq0_HNFq1_mod2.Cr <- psem(
  ...
  lme(ln.HNF_q1 ~ ln.Bac_q0 + ln.HNF_Biom + HNF_select + ln.Temp + ln.Sal + ln.PAR + ln.DIN + ln.PO3 + ln.Chla, 
      random = ~ 1 | Cruise, data = HNF_Bac_A),
  lme(ln.Bac_Biom ~ ln.HNF_Biom + ln.HNF_q1 + ln.Temp + ln.Sal + ln.PAR + ln.DIN + ln.PO3 + ln.Chla, 
      random = ~ 1 | Cruise, data = HNF_Bac_A),

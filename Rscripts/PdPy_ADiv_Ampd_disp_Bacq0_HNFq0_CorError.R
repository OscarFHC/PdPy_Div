...
p_Adiv_pairs <- HNF_Bac_A %>%
  ...
  theme(strip.text.x = element_text(color = "black", size = 14),
        strip.text.y = element_text(angle = 45, color = "black", size = 14))
p_Adiv_pairs
ggsave(p_Adiv_pairs, file = "D:/Research/PdPy_Div_Results/Figs/p_ADiv_pairsZoomIn_ln_disp.jpeg",
       dpi = 600, width = 34, height = 28, units = "cm")
...
gam_select <- gam(ln.HNF_q0 ~ ln.Bac_q0*Bac_select + ln.Bac_q0*HNF_select + Bac_disp + HNF_disp, data = HNF_Bac_A)
summary(gam_select)
lme_select <- lme(ln.HNF_q0 ~ ln.Bac_q0*Bac_select + ln.Bac_q0*HNF_select + Bac_disp + HNF_disp, 
...
### linear model
HNFq0_Bacq0_0 <- glm(ln.HNF_q0 ~ ln.Bac_q0, data = HNF_Bac_A)
HNFq0_Bacq0_1 <- glm(ln.HNF_q0 ~ ln.Bac_q0 + HNF_select, data = HNF_Bac_A)
HNFq0_Bacq0_2 <- glm(ln.HNF_q0 ~ ln.Bac_q0 * HNF_select + Bac_disp + HNF_disp, data = HNF_Bac_A)
anova(HNFq0_Bacq0_0, HNFq0_Bacq0_1, HNFq0_Bacq0_2, test = "F")
summary(HNFq0_Bacq0_2)
...
p_ADiv_Select
# ggsave(p_ADiv_Select, file = "D:/Research/PdPy_Div_Results/Figs/p_ADiv_Bacq0_HNFq0_Ampd.jpeg",
#        dpi = 600, width = 34, height = 28, units = "cm")
##### add selection and dispersal #####
###############################################################################################
##### Simple HNF and Bac alppha diversity relationship  #######################################
...
Bacq0_BacS.0 <- lm(ln.Bac_q0 ~ Bac_select + Bac_disp, data = HNF_Bac_A)
Bacq0_BacS.Cr <- lme(ln.Bac_q0 ~ Bac_select + Bac_disp, random = ~ 1 | Cruise, data = HNF_Bac_A)
Bacq0_BacS.Season <- lme(ln.Bac_q0 ~ Bac_select + Bac_disp, random = ~ 1 | Season, data = HNF_Bac_A)
Bacq0_BacS.St <- lme(ln.Bac_q0 ~ Bac_select + Bac_disp, random = ~ 1 | Station, data = HNF_Bac_A)
...
# ggsave(p_HNFq0_BacSelect_Bacq0, file = "D:/Research/PdPy_Div_Results/Figs/p_HNFq0_BacAmpd_Bacq0.png",
...
HNFq0_HNFS.0 <- lm(ln.HNF_q0 ~ HNF_select + HNF_disp, data = HNF_Bac_A)
HNFq0_HNFS.Cr <- lme(ln.HNF_q0 ~ HNF_select + HNF_disp, random = ~ 1 | Cruise, data = HNF_Bac_A)
HNFq0_HNFS.Season <- lme(ln.HNF_q0 ~ HNF_select + HNF_disp, random = ~ 1 | Season, data = HNF_Bac_A)
HNFq0_HNFS.St <- lme(ln.HNF_q0 ~ HNF_select + HNF_disp, random = ~ 1 | Station, data = HNF_Bac_A)
...
ggsave(p_Select_Bacq0_HNFq0, file = "D:/Research/PdPy_Div_Results/Figs/p_Bacq0_HNFAmpd_HNFq0.png",
       dpi = 600, width = 56, height = 28, units = "cm")
##### Bacq0 -> HNF selection ->  HNFq0 ##########
...
Bacq0_HNFq0_mod1.0 <- '
  # regressions
    ln.Bac_q0 ~ Bac_select + Bac_disp 
    ln.HNF_q0 ~ HNF_select + HNF_disp
...
Bacq0_HNFq0_mod1.2 <- '
  # regressions
    ln.Bac_q0 ~ Bac_select + Bac_disp
    ln.HNF_q0 ~ HNF_select + HNF_disp + ln.Bac_Biom
    Bac_select ~ ln.HNF_q0
    HNF_select ~ ln.Bac_q0
...
Bacq0_HNFq0_mod1.3 <- '
  # regressions
    ln.Bac_q0 ~ Bac_select + Bac_disp + ln.HNF_Biom
    ln.HNF_q0 ~ HNF_select + HNF_disp + ln.Bac_Biom
    Bac_select ~ ln.HNF_q0
    HNF_select ~ ln.Bac_q0
    ln.Bac_Biom ~ ln.Bac_q0

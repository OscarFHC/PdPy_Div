...
p_Envi_pairs <- HNF_Bac_A %>%
  ggpairs(columns = c("ln.Temp", "ln.Sal", "ln.PAR", "ln.NO2", "ln.NO3", "ln.DIN", "ln.PO3"),
...
Envi <- HNF_Bac_A[, c("Temp", "Sal", "PAR", "NO2", "NO3", "PO3")]
ln.Envi <- HNF_Bac_A[, c("ln.Temp", "ln.Sal", "ln.PAR", "ln.NO2", "ln.NO3", "ln.PO3", "ln.DIN")]
...
Build the path model from simple. 

![](https://github.com/OscarFHC/PdPy_Div/blob/master/data/HypoFigs/sem_L1.pdf)

...
# Phylogenetic turnover / Selection strength
...
Bac_null <- abind(as.matrix(comdistnt(Bac_comm, cophenetic(Bac_phylo))), 
                  replicate(999, comdistnt.shuffle(Bac_comm, Bac_phylo)))

...
p_HNFq2_Bacq0
# ggsave(p_HNFq2_Bacq0, file = "D:/Research/PdPy_Div_Results/Figs/p_ADiv_Bacq0_HNFq2.jpeg",
#        dpi = 600, width = 34, height = 28, units = "cm")
##### without selection #####

##### add selection #####
### linear model
HNFq2_Bacq0_0 <- glm(ln.HNF_q2 ~ ln.Bac_q0 + HNF_select, data = HNF_Bac_A)
HNFq2_Bacq0_1 <- glm(ln.HNF_q2 ~ ln.Bac_q0 * HNF_select + HNF_select * ln.Bac_q0, data = HNF_Bac_A)
...
p_ADiv_Select
# ggsave(p_ADiv_Select, file = "D:/Research/PdPy_Div_Results/Figs/p_ADiv_Bacq0_HNFq2_Select.jpeg",
#        dpi = 600, width = 34, height = 28, units = "cm")
##### add selection #####
###############################################################################################
##### Simple HNF and Bac alppha diversity relationship  #######################################
...
###############################################################################################
##### Testing hypothesis: HNFq2 -> Bac selection -> Bacq0 & Bacq0 -> Bac selection ->  HNFq2 ##
###############################################################################################
##### HNFq2 -> Bac selection -> Bacq0 ##########
### linear model testing
BacS_HNFq2.0 <- lm(Bac_select ~ ln.HNF_q2, data = HNF_Bac_A)
BacS_HNFq2.Cr <- lme(Bac_select ~ ln.HNF_q2, random = ~ 1 | Cruise, data = HNF_Bac_A)
BacS_HNFq2.Season <- lme(Bac_select ~ ln.HNF_q2, random = ~ 1 | Season, data = HNF_Bac_A)
BacS_HNFq2.St <- lme(Bac_select ~ ln.HNF_q2, random = ~ 1 | Station, data = HNF_Bac_A)
AIC(BacS_HNFq2.0, BacS_HNFq2.Cr, BacS_HNFq2.Season, BacS_HNFq2.St)
summary(BacS_HNFq2.Cr)
summary(gam(Bac_select ~ s(ln.HNF_q2, bs = "ts"), data = HNF_Bac_A))
...
# ggsave(p_HNFq2_BacSelect_Bacq0, file = "D:/Research/PdPy_Div_Results/Figs/p_HNFq2_BacSelect_Bacq0.jpeg",
#        dpi = 600, width = 34, height = 28, units = "cm")
##### HNFq2 -> Bac selection -> Bacq0 ##########
...
HNFq2_HNFS.0 <- lm(ln.HNF_q2 ~ HNF_select, data = HNF_Bac_A)
HNFq2_HNFS.Cr <- lme(ln.HNF_q2 ~ HNF_select, random = ~ 1 | Cruise, data = HNF_Bac_A)
HNFq2_HNFS.Season <- lme(ln.HNF_q2 ~ HNF_select, random = ~ 1 | Season, data = HNF_Bac_A)
HNFq2_HNFS.St <- lme(ln.HNF_q2 ~ HNF_select, random = ~ 1 | Station, data = HNF_Bac_A)
AIC(HNFq2_HNFS.0, HNFq2_HNFS.Cr, HNFq2_HNFS.Season, HNFq2_HNFS.St)
summary(HNFq2_HNFS.Cr)
summary(gam(ln.HNF_q2 ~ s(HNF_select, bs = "ts"), data = HNF_Bac_A))
...
summary(Bacq0_HNFq2_psem2.Season)
...
anova(Bacq0_HNFq2_psem2.0, Bacq0_HNFq2_psem2.Cr)
summary(Bacq0_HNFq2_psem2.Cr)
##### Step 2 : include grouping variables (random effects) and environmental variables #####
